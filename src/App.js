      ...
      <div>
        ...
        { this.state.entries.length > 0 && 
          <div className="main-content main-author">
              made  by <a href="https://twitter.com/daviducolo">Davide Santangelo</a>. source on <a href="https://github.com/davidesantangelo/feedi">github <i className="fab fa-github"></i></a>, support on bmc <a href="https://www.buymeacoffee.com/582rhJH" target="_BLANK"  rel="noopener noreferrer">buy me a coffee <i className="fas fa-coffee"></i></a>.
          </div>
        }
      </div>
    );
